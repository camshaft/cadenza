(case "sftG five dispatches (push x3 popmin push) — push appends then sifts UP by parent swaps answering the new root, popmin moves the last element to the root and sifts DOWN answering the old root, and the seeded pushes force different swap paths on the two runs"
  (input  (do
            (effect H
              (op push (-> Int64 Int64))
              (op popmin (-> Int64)))
            ...
            (export main)))
  (call   main (: 10 Int64)) (output (: 1204040407 Int64))
  (call   main (: 0 Int64)) (output (: 202020197 Int64)))
