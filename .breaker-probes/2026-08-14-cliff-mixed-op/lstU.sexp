(case "lstU the lstQ program with the enq op DECLARED and HANDLED but never performed — tuple-of-two-lists state, the refill branch reverses the in-stack through a recursive def, drained answers -99"
  (input  (do
