...
#[derive(Serialize)]
pub struct Example {
    /// The example identifier (e.g., "welcome", "arithmetic").
    pub id: String,
    /// The display name for the example.
    pub name: String,
    /// The source code content.
    pub source: String,
}

/// Returns the list of available examples.
///
/// Returns a JSON array of examples with:
...
pub fn get_examples() -> JsValue {
    let examples = vec![
        Example {
            ...
            source: include_str!("../../cadenza-eval/test-data/example-welcome.cdz").to_string(),
        },
        Example {
            id: "arithmetic".to_string(),
            name: "Arithmetic".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-arithmetic.cdz").to_string(),
        },
        Example {
            id: "comparison".to_string(),
            name: "Comparison".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-comparison.cdz").to_string(),
        },
        Example {
            id: "variables".to_string(),
            name: "Variables".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-variables.cdz").to_string(),
        },
        Example {
            id: "functions".to_string(),
            name: "Functions".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-functions.cdz").to_string(),
        },
        Example {
            id: "literals".to_string(),
            name: "Literals".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-literals.cdz").to_string(),
        },
        Example {
            id: "measures".to_string(),
            name: "Units of Measure".to_string(),
            source: include_str!("../../cadenza-eval/test-data/example-measures.cdz").to_string(),
        },
    ];

    serde_wasm_bindgen::to_value(&examples).expect("Failed to serialize examples")
}
