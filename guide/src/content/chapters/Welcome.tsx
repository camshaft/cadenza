  ...
  return (
    <article>
      ...
      <Why tenet="One representation, many syntaxes">
        A Cadenza program isn't <em>really</em> text — it's a uniform data structure (code as data),
        ...
        and which syntax you chose can never change a program's identity — the identity is the tree,
        not the text.
      </Why>
      ...
      <Why tenet="Decline, don't miscompile">
        ...
        refusal is never a dead end, either — the goal is that every rejection carries a machine-checkable
