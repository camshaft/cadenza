  ...
  return (
    <article>
      ...
      <P>
        ...
        is what <C>cdz add</C> and <C>cdz remove</C> edit for you. You can also set the build tier a project
        prefers with <C>def opt-level = "O2"</C>, which an explicit <C>--opt-level</C> on the command line
        overrides.
      </P>
