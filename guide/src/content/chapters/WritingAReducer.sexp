...
(def (main) (apply #record((= family "message") (= version 1)) (None) (None)))))
  (p "The result is " (result (of "reducer-empty") (: #list() (List EffectRequest))) ", the empty list: no effects, for any event. To turn this program into something the kernel can run, you compile it as a " (em "component") " bound to the reducer interface, naming that interface on the command line:")
