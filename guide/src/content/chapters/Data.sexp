(chapter
  ...
  (p "Two tuples or two records are equal when their contents are, which is structural equality, not identity. A tuple matches position by position, so " (c "#tuple(1 2)") " equals another " (c "#tuple(1 2)") ":")
  (runnable
