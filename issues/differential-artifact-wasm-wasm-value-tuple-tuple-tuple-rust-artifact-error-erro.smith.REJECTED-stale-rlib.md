# SMITH FINDING — backends DISAGREE on value: [artifact] wasm=wasm value (tuple 0.1 (tuple 0.1 (tuple 195 127))) rust=artifact-error error[E0433]: cannot find module or crate `cdz_num` in this scope
...
- **Hits:** 1
- **Signature:** `differential-artifact-wasm-wasm-value-tuple-tuple-tuple-rust-artifact-error-erro`

## Reproducer

`differential-artifact-wasm-wasm-value-tuple-tuple-tuple-rust-artifact-error-erro.smith.sexp` (also inline):
...
```
cargo run -p cdz-smith -- verify differential-artifact-wasm-wasm-value-tuple-tuple-tuple-rust-artifact-error-erro.smith.sexp
```
...
- **Disagreement:** [artifact] wasm=wasm value (tuple 0.1 (tuple 0.1 (tuple 195 127))) rust=artifact-error error[E0433]: cannot find module or crate `cdz_num` in this scope
