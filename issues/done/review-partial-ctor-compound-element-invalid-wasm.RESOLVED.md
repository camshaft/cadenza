...
<!-- UPDATE 2026-07-16 (corpus-bugfix): v-runtime FIXED the invalid-wasm face (MR b617a065b, pending pr-sync) — newtype-erasure ran before the arity guard; now declines cleanly (reject-don-t-miscompile). Repro promoted to a graded TODO (intended 15 once the runtime eta-closure lift lands = remaining OPEN sub-face, now a clean todo not a miscompile). Mark RESOLVED-as-miscompile once b617a065b lands; the eta-lift todo stays open. -->
