# SMITH FINDING — backends DISAGREE on value: [artifact] wasm=wasm value (tuple (tuple "" (tuple (tuple "" (tuple "" "" 110.28)) (tuple "" "" 110.28) 127)) 127 127) rust=artifact-error error[E0433]: cannot find module or crate `cdz_num` in this scope
...
- **Hits:** 1
- **Signature:** `differential-artifact-wasm-wasm-value-tuple-tuple-tuple-tuple-tuple-tuple-rust-a`

## Reproducer

`differential-artifact-wasm-wasm-value-tuple-tuple-tuple-tuple-tuple-tuple-rust-a.smith.sexp` (also inline):
...
```
cargo run -p cdz-smith -- verify differential-artifact-wasm-wasm-value-tuple-tuple-tuple-tuple-tuple-tuple-rust-a.smith.sexp
```
...
- **Disagreement:** [artifact] wasm=wasm value (tuple (tuple "" (tuple (tuple "" (tuple "" "" 110.28)) (tuple "" "" 110.28) 127)) 127 127) rust=artifact-error error[E0433]: cannot find module or crate `cdz_num` in this scope
