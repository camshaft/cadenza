...
(case "a slice reads correctly after its parent binding's last direct use"
  (doc    "The reclaim-window shape: `parent` (a CONCAT rope, so its storage is runtime-built) is last
