...
; --- Sibling borrowed-rope-key/elem cases carrying the identical 2-site consume-misclass as 2482/2483
;     (MapRemove key, SetContains elem, SetRemove elem). Value-correct (compaction hits the flat twin) but
;     LEAK 1 (the surplus dup of the live-after borrowed key/elem — mark_binder_dups marks it consume, then
;     the escape predicate keeps its slot ⟹ net rc1). Pinned known-leak = honest immediate UAF-class guard;
  ...
  (input
    (do
      ...
      (def
        (main (: sel Int64))
        (let
          ((m (Map.insert (Map.insert Map.empty (Bytes.of #list(104 120)) 42) (Bytes.of #list(200)) 9))
           (k (rep (Bytes.of #list(104)) sel)))
          (+ (* 100 (Map.len (Map.remove m k))) (Bytes.len k))))
      (export main)))
  (call main (: 1 Int64))
  (output (: 102 Int64))
  ...
  (input
    (do
      ...
      (def
        (main (: sel Int64))
        (let
          ((s #set((Bytes.of #list(104 120)) (Bytes.of #list(200))))
           (e (rep (Bytes.of #list(104)) sel)))
          (+ (if (Set.contains s e) 100 0) (Bytes.len e))))
      (export main)))
  (call main (: 1 Int64))
  (output (: 102 Int64))
    ...
    (do
      ...
      (def
        ...
        (let
          ((s #set((Bytes.of #list(104 120)) (Bytes.of #list(200))))
           (e (rep (Bytes.of #list(104)) sel)))
          (+ (* 100 (Set.len (Set.remove s e))) (Bytes.len e))))
      (export main)))
  (call main (: 1 Int64))
  (output (: 102 Int64))
