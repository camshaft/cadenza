...
(case "a SEVEN-op handler — the widest arm table in the corpus, each op a distinct answer shape and stride, order scrambled"
  (doc    "Op-COUNT scaling of one handler's dispatch table: the landed handlers top out around 3-4 ops; this
