    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m (#tuple(s k) (if (= s "hi") k -1))))
          ((None u) -1)))
      (export main)))
  (call main (: 5 Int64))
  (output (: 5 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m ((Some k) -1) ((None u) n)))
          ((None u) -2)))
      (export main)))
  (call main (: 4 Int64))
  (output (: 4 Int64))
    ...
    (do
      ...
      (def
        ...
        (match
          ...
          ((Some s) (match s ((Rect a b) (+ (* a 1000) b)) ((Circle r) -1)))
          ((None u) -2)))
      (export main)))
  (call main (: 5 Int64))
  (output (: 5006 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some s) (if (Set.contains s (+ n 5)) (+ (* (Set.len s) 1000) n) -1))
          ((None u) -2)))
      (export main)))
  (call main (: 7 Int64))
  (output (: 3007 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m (#tuple(a b) (if (= b 2.5) a -1))))
          ((None u) -2)))
      (export main)))
  (call main (: 7 Int64))
  (output (: 7 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some r) (if (= r (Rational.of n 8)) n -1))
          ((None u) -2)))
      (export main)))
  (call main (: 6 Int64))
  (output (: 6 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m (#tuple(k c) (if (= c #\A) k -1))))
          ((None u) -1)))
      (export main)))
  (call main (: 5 Int64))
  (output (: 5 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m (#tuple(k v) (if (= v b"ABC") k -1))))
          ((None u) -1)))
      (export main)))
  (call main (: 4 Int64))
  (output (: 4 Int64))
    ...
    (do
      (def
        ...
        (match
          ...
          ((Some m) (match m (#tuple(k s) (if (= s #"kg") k -1))))
          ((None u) -1)))
      (export main)))
  (call main (: 3 Int64))
  (output (: 3 Int64))
    ...
    (do
      (def
        ...
        (let
          ...
          (match r ((Some m) (match m (#tuple(a c) (+ (* a 1000) c)))) ((None u) -1))))
      (export main)))
  (call main (: 7 Int64))
  (output (: 7107 Int64))
  (call main (: 4 Int64))
...
(case
  ...
  (input
    (do
      ...
      (def
        (main (: n Int64))
        (match (: (Value.decode (Value.encode (Ack))) (Option Ack)) ((Some m) n) ((None u) -1)))
      (export main)))
  (call main (: 5 Int64))
  (output (: 5 Int64))
  (call main (: 9 Int64))
      ...
      (def
        ...
        (let
          ...
          (let
            ...
            (match p ((Some q) (match q ((Pt.Mk r) (+ r.x r.y)))) ((None u) -1)))))
      (export main)))
  (call main (: 7 Int64))
  (output (: 114 Int64))
  (live-objects 0))
