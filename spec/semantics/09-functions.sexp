...
(case "a closure applied through an unbuilt sibling variant compiles and runs"
  (doc    "`T` boxes a `Unary (Int64->Int64)` and a `Binary (Int64->Int64->Int64)`; `apply-it` matches both
...
(case "the built variant is the multi-arg one, the unbuilt arm still gets its call type"
  (doc    "The symmetric direction: `main` builds the `Binary` variant, so the `Unary` arm's `(f x)` —
...
(case "a consumed heap param on a self-recursive loop's non-tail spine is not double-freed"
  ...
  (input  (do
            ...
            (export main)))
  (call   main (: 2 Int64)) (output (: 9 Int64)) (live-objects 0))
...
(case "wfp1 SEVENTEEN scalar entry params decline pending the memory-indirect convention"
  (input (do
    (def (main (: p0 Int64) (: p1 Int64) (: p2 Int64) (: p3 Int64) (: p4 Int64) (: p5 Int64) (: p6 Int64) (: p7 Int64) (: p8 Int64) (: p9 Int64) (: p10 Int64) (: p11 Int64) (: p12 Int64) (: p13 Int64) (: p14 Int64) (: p15 Int64) (: p16 Int64)) (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ p0 p1) p2) p3) p4) p5) p6) p7) p8) p9) p10) p11) p12) p13) p14) p15) p16))
    (export main)))
  (call main (: 0 Int64) (: 1 Int64) (: 2 Int64) (: 3 Int64) (: 4 Int64) (: 5 Int64) (: 6 Int64) (: 7 Int64) (: 8 Int64) (: 9 Int64) (: 10 Int64) (: 11 Int64) (: 12 Int64) (: 13 Int64) (: 14 Int64) (: 15 Int64) (: 16 Int64))
  (output (: 136 Int64)))

(case "wfp2 EIGHT list entry params are sixteen flat values — the lifted boundary edge sums their lengths"
  (input (do
...
(case "eoc1 an Option entry param captured by a local closure applied twice"
  (input (do (def (main (: o (Option Int64)))
    (let ((f (fn ((: k Int64)) (+ k (match o ((Option.Some v) v) ((Option.None) 0))))))
      (+ (f 10) (f 100)))) (export main)))
  (call main (: (Some 7) (Option Int64)))
  (output (: 124 Int64)))

(case "eoc2 an Option entry param relayed to a helper def and unwrapped there (owned sum, unlike the borrowed list)"
  (input (do
...
(case "eoc3 an Option entry param matched twice reclaims (the repeat-unwrap family needs a heap payload)"
  (input (do (def (main (: o (Option Int64)))
    (+ (match o ((Option.Some v) v) ((Option.None) -1))
...
(case "immortal-nullary FBIP witness: a recursive Nat walk REBUILDS the spine (FBIP-reuses S cells) and returns a fresh terminal (Z), then re-folds it — value-correct + the rebuilt immortal Z is shared (0-leak after the immortal fix)"
  ...
  (input (do
    ...
    (export main)))
  (call main (: 5 Int64)) (output (: 5 Int64))
  (call main (: 0 Int64)) (output (: 0 Int64)) (live-objects known-leak))
