...
| `spec/capabilities/core-semantics.md` | §3, §10, §11 |
...
| §4 Determinism and bounded execution | constitution.md; deterministic-value-form.md; determinism-and-fuel.md; memory-and-resource-model.md; numeric-model.md |
| §5 Types | constitution.md; component-abi.md; type-system.md; numeric-model.md; units-of-measure.md |
