...
mod width_faults;
use width_faults::*;
pub(crate) use width_faults::{
    FLOAT_WIDTH_MESSAGE, ill_formed_float_width_fix, ill_formed_int_width_fix,
    ill_formed_int_width_message, int_width_range, nested_runtime_width_type,
    unbound_width_message,
};
