...
pub const REQUIRED_RUNTIME_HASH: &str = match option_env!("CDZ_RUNTIME_HASH") {
    Some(h) => h,
    None => "051neLQAH4mumucGhjOLDUqpdw2rIDl6oriqOSK3O8DQr",
};
...
pub const DEBUG_RUNTIME_HASH: &str = match option_env!("CDZ_DEBUG_RUNTIME_HASH") {
    Some(h) => h,
    None => "05OU7cA8ZvnZxhATHy9Jf3O2jkgz3PI9GylN6qRW6zgp4",
};
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    mark_immortal_deep: &RUNTIME_OPS[52],
    rational_add: &RUNTIME_OPS[53],
    rational_cmp: &RUNTIME_OPS[54],
    rational_den: &RUNTIME_OPS[55],
    rational_div: &RUNTIME_OPS[56],
    rational_mul: &RUNTIME_OPS[57],
    rational_num: &RUNTIME_OPS[58],
    rational_of: &RUNTIME_OPS[59],
    rational_sub: &RUNTIME_OPS[60],
    reset: &RUNTIME_OPS[61],
    set_contains: &RUNTIME_OPS[62],
    set_difference: &RUNTIME_OPS[63],
    set_empty: &RUNTIME_OPS[64],
    set_insert: &RUNTIME_OPS[65],
    set_intersection: &RUNTIME_OPS[66],
    set_iter: &RUNTIME_OPS[67],
    set_iter_elem: &RUNTIME_OPS[68],
    set_iter_next: &RUNTIME_OPS[69],
    set_remove: &RUNTIME_OPS[70],
    set_size: &RUNTIME_OPS[71],
    set_to_list: &RUNTIME_OPS[72],
    set_union: &RUNTIME_OPS[73],
    str_from_bytes: &RUNTIME_OPS[74],
    str_get: &RUNTIME_OPS[75],
    str_new: &RUNTIME_OPS[76],
    str_nfc_normalize: &RUNTIME_OPS[77],
    sum_disc: &RUNTIME_OPS[78],
    sum_new: &RUNTIME_OPS[79],
    sum_new_reuse: &RUNTIME_OPS[80],
    sum_payload: &RUNTIME_OPS[81],
    value_canonicalize: &RUNTIME_OPS[82],
    value_cmp: &RUNTIME_OPS[83],
    value_decode: &RUNTIME_OPS[84],
    value_encode: &RUNTIME_OPS[85],
    value_eq: &RUNTIME_OPS[86],
    value_eq_shaped: &RUNTIME_OPS[87],
    vec_concat: &RUNTIME_OPS[88],
    vec_drop: &RUNTIME_OPS[89],
    vec_empty: &RUNTIME_OPS[90],
