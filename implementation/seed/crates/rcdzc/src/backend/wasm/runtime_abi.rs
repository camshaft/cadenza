...
pub const REQUIRED_RUNTIME_HASH: &str = match option_env!("CDZ_RUNTIME_HASH") {
    Some(h) => h,
    None => "05qe1vv0tfBx7XVoPpgt8JeBaFjTX3z6PuHB9a9JBRmMV",
};
...
pub const DEBUG_RUNTIME_HASH: &str = match option_env!("CDZ_DEBUG_RUNTIME_HASH") {
    Some(h) => h,
    None => "05KvVyZHSZVHJ3iizmZhuZcLUm3cEWi0A35MBZBacjLJR",
};
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    rational_add: &RUNTIME_OPS[51],
    rational_cmp: &RUNTIME_OPS[52],
    rational_den: &RUNTIME_OPS[53],
    rational_div: &RUNTIME_OPS[54],
    rational_mul: &RUNTIME_OPS[55],
    rational_num: &RUNTIME_OPS[56],
    rational_of: &RUNTIME_OPS[57],
    rational_sub: &RUNTIME_OPS[58],
    reset: &RUNTIME_OPS[59],
    set_contains: &RUNTIME_OPS[60],
    set_difference: &RUNTIME_OPS[61],
    set_empty: &RUNTIME_OPS[62],
    set_insert: &RUNTIME_OPS[63],
    set_intersection: &RUNTIME_OPS[64],
    set_iter: &RUNTIME_OPS[65],
    set_iter_elem: &RUNTIME_OPS[66],
    set_iter_next: &RUNTIME_OPS[67],
    set_remove: &RUNTIME_OPS[68],
    set_size: &RUNTIME_OPS[69],
    set_to_list: &RUNTIME_OPS[70],
    set_union: &RUNTIME_OPS[71],
    str_from_bytes: &RUNTIME_OPS[72],
    str_get: &RUNTIME_OPS[73],
    str_new: &RUNTIME_OPS[74],
    str_nfc_normalize: &RUNTIME_OPS[75],
    sum_disc: &RUNTIME_OPS[76],
    sum_new: &RUNTIME_OPS[77],
    sum_new_reuse: &RUNTIME_OPS[78],
    sum_payload: &RUNTIME_OPS[79],
    value_canonicalize: &RUNTIME_OPS[80],
    value_cmp: &RUNTIME_OPS[81],
    value_decode: &RUNTIME_OPS[82],
    value_encode: &RUNTIME_OPS[83],
    value_eq: &RUNTIME_OPS[84],
    value_eq_shaped: &RUNTIME_OPS[85],
    vec_concat: &RUNTIME_OPS[86],
    vec_drop: &RUNTIME_OPS[87],
    vec_empty: &RUNTIME_OPS[88],
    vec_get: &RUNTIME_OPS[89],
    vec_len: &RUNTIME_OPS[90],
    vec_of_arr: &RUNTIME_OPS[91],
    vec_push: &RUNTIME_OPS[92],
    vec_split: &RUNTIME_OPS[93],
    vec_update: &RUNTIME_OPS[94],
};
