...
pub const REQUIRED_RUNTIME_HASH: &str = match option_env!("CDZ_RUNTIME_HASH") {
    Some(h) => h,
    None => "05SMwaMXiD54hBQj08UsH7cBlj4TqGez5NVnugFrgO6XH",
};
...
pub const DEBUG_RUNTIME_HASH: &str = match option_env!("CDZ_DEBUG_RUNTIME_HASH") {
    Some(h) => h,
    None => "05qB85Dr4KXz9QTboH04OeQBiBsjobmqHRUFXigkNNjIJ",
};
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    drop: &RUNTIME_OPS[29],
    dup: &RUNTIME_OPS[30],
    dup_if_shared: &RUNTIME_OPS[31],
    get_bool: &RUNTIME_OPS[32],
    get_float: &RUNTIME_OPS[33],
    get_float32: &RUNTIME_OPS[34],
    get_int: &RUNTIME_OPS[35],
    hash_blake3: &RUNTIME_OPS[36],
    live_objects: &RUNTIME_OPS[37],
    map_alloc: &RUNTIME_OPS[38],
    map_empty: &RUNTIME_OPS[39],
    map_insert: &RUNTIME_OPS[40],
    map_iter: &RUNTIME_OPS[41],
    map_iter_key: &RUNTIME_OPS[42],
    map_iter_next: &RUNTIME_OPS[43],
    map_iter_val: &RUNTIME_OPS[44],
    map_key: &RUNTIME_OPS[45],
    map_len: &RUNTIME_OPS[46],
    map_lookup: &RUNTIME_OPS[47],
