...
pub const REQUIRED_RUNTIME_HASH: &str = "05mGaKEECs7JMDpraAnB5JtoRSVW5sUv9OO4xEaZkK7OF";
...
pub const DEBUG_RUNTIME_HASH: &str = "05BCrkfFffkprR2XATx4y4h409WWezn7kmYk4NCIFkYk2";
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    map_to_list: &RUNTIME_OPS[45],
    map_val: &RUNTIME_OPS[46],
    rational_add: &RUNTIME_OPS[47],
    rational_cmp: &RUNTIME_OPS[48],
    rational_den: &RUNTIME_OPS[49],
    rational_div: &RUNTIME_OPS[50],
    rational_mul: &RUNTIME_OPS[51],
    rational_num: &RUNTIME_OPS[52],
    rational_of: &RUNTIME_OPS[53],
    rational_sub: &RUNTIME_OPS[54],
    reset: &RUNTIME_OPS[55],
    set_contains: &RUNTIME_OPS[56],
    set_difference: &RUNTIME_OPS[57],
    set_empty: &RUNTIME_OPS[58],
    set_insert: &RUNTIME_OPS[59],
    set_intersection: &RUNTIME_OPS[60],
    set_iter: &RUNTIME_OPS[61],
    set_iter_elem: &RUNTIME_OPS[62],
    set_iter_next: &RUNTIME_OPS[63],
    set_remove: &RUNTIME_OPS[64],
