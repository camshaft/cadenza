...
pub const REQUIRED_RUNTIME_HASH: &str =
    "c0ee4a5cb2a386ada4f4cd85aa2fbb53b6a2ce068efbe1ca33f66e63bb49d01c";
...
pub const DEBUG_RUNTIME_HASH: &str =
    "fa85b2cf0fc1006bbaa6646266481fc55eecab3b95f2ea2533aee325fe31c87d";
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    bigint_sub: &RUNTIME_OPS[10],
    bigint_to_i64_checked: &RUNTIME_OPS[11],
    box_bool: &RUNTIME_OPS[12],
    box_float: &RUNTIME_OPS[13],
    box_float32: &RUNTIME_OPS[14],
    box_int: &RUNTIME_OPS[15],
    bytes_alloc: &RUNTIME_OPS[16],
    bytes_compact: &RUNTIME_OPS[17],
    bytes_concat: &RUNTIME_OPS[18],
    bytes_get: &RUNTIME_OPS[19],
    bytes_len: &RUNTIME_OPS[20],
    bytes_set: &RUNTIME_OPS[21],
    bytes_slice: &RUNTIME_OPS[22],
    drop: &RUNTIME_OPS[23],
    dup: &RUNTIME_OPS[24],
    get_bool: &RUNTIME_OPS[25],
    get_float: &RUNTIME_OPS[26],
    get_float32: &RUNTIME_OPS[27],
    get_int: &RUNTIME_OPS[28],
    live_objects: &RUNTIME_OPS[29],
    map_alloc: &RUNTIME_OPS[30],
    map_empty: &RUNTIME_OPS[31],
    map_insert: &RUNTIME_OPS[32],
    map_iter: &RUNTIME_OPS[33],
    map_iter_key: &RUNTIME_OPS[34],
    map_iter_next: &RUNTIME_OPS[35],
    map_iter_val: &RUNTIME_OPS[36],
    map_key: &RUNTIME_OPS[37],
    map_len: &RUNTIME_OPS[38],
    map_lookup: &RUNTIME_OPS[39],
    map_remove: &RUNTIME_OPS[40],
    map_set: &RUNTIME_OPS[41],
    map_size: &RUNTIME_OPS[42],
    map_val: &RUNTIME_OPS[43],
    reset: &RUNTIME_OPS[44],
    set_contains: &RUNTIME_OPS[45],
    set_difference: &RUNTIME_OPS[46],
    set_empty: &RUNTIME_OPS[47],
    set_insert: &RUNTIME_OPS[48],
    set_intersection: &RUNTIME_OPS[49],
    set_iter: &RUNTIME_OPS[50],
    set_iter_elem: &RUNTIME_OPS[51],
    set_iter_next: &RUNTIME_OPS[52],
    set_remove: &RUNTIME_OPS[53],
    set_size: &RUNTIME_OPS[54],
    set_union: &RUNTIME_OPS[55],
    str_get: &RUNTIME_OPS[56],
    str_new: &RUNTIME_OPS[57],
    sum_disc: &RUNTIME_OPS[58],
    sum_new: &RUNTIME_OPS[59],
    sum_new_reuse: &RUNTIME_OPS[60],
    sum_payload: &RUNTIME_OPS[61],
