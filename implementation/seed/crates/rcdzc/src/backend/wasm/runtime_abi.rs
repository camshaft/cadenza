...
pub const REQUIRED_RUNTIME_HASH: &str = match option_env!("CDZ_RUNTIME_HASH") {
    Some(h) => h,
    None => "05m2171MKmCx4WJ03B1LoTcysWxLcfEAMWIAyFCzUWjeY",
};
...
pub const DEBUG_RUNTIME_HASH: &str = match option_env!("CDZ_DEBUG_RUNTIME_HASH") {
    Some(h) => h,
    None => "052KQzQPcbCdcXbRnlIWfrWa4DHGmIom7eKHkv7uGCSFG",
};
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    bytes_set: &RUNTIME_OPS[26],
    bytes_slice: &RUNTIME_OPS[27],
    drop: &RUNTIME_OPS[28],
    dup: &RUNTIME_OPS[29],
    get_bool: &RUNTIME_OPS[30],
    get_float: &RUNTIME_OPS[31],
    get_float32: &RUNTIME_OPS[32],
    get_int: &RUNTIME_OPS[33],
    hash_blake3: &RUNTIME_OPS[34],
    live_objects: &RUNTIME_OPS[35],
    map_alloc: &RUNTIME_OPS[36],
    map_empty: &RUNTIME_OPS[37],
    map_insert: &RUNTIME_OPS[38],
    map_iter: &RUNTIME_OPS[39],
    map_iter_key: &RUNTIME_OPS[40],
    map_iter_next: &RUNTIME_OPS[41],
    map_iter_val: &RUNTIME_OPS[42],
    map_key: &RUNTIME_OPS[43],
    map_len: &RUNTIME_OPS[44],
    map_lookup: &RUNTIME_OPS[45],
    map_remove: &RUNTIME_OPS[46],
    map_set: &RUNTIME_OPS[47],
    map_size: &RUNTIME_OPS[48],
    map_to_list: &RUNTIME_OPS[49],
    map_val: &RUNTIME_OPS[50],
    mark_immortal: &RUNTIME_OPS[51],
    rational_add: &RUNTIME_OPS[52],
    rational_cmp: &RUNTIME_OPS[53],
    rational_den: &RUNTIME_OPS[54],
    rational_div: &RUNTIME_OPS[55],
    rational_mul: &RUNTIME_OPS[56],
    rational_num: &RUNTIME_OPS[57],
    rational_of: &RUNTIME_OPS[58],
    rational_sub: &RUNTIME_OPS[59],
    reset: &RUNTIME_OPS[60],
    set_contains: &RUNTIME_OPS[61],
    set_difference: &RUNTIME_OPS[62],
    set_empty: &RUNTIME_OPS[63],
    set_insert: &RUNTIME_OPS[64],
    set_intersection: &RUNTIME_OPS[65],
    set_iter: &RUNTIME_OPS[66],
    set_iter_elem: &RUNTIME_OPS[67],
    set_iter_next: &RUNTIME_OPS[68],
    set_remove: &RUNTIME_OPS[69],
    set_size: &RUNTIME_OPS[70],
    set_to_list: &RUNTIME_OPS[71],
    set_union: &RUNTIME_OPS[72],
    str_from_bytes: &RUNTIME_OPS[73],
    str_get: &RUNTIME_OPS[74],
    str_new: &RUNTIME_OPS[75],
    str_nfc_normalize: &RUNTIME_OPS[76],
    sum_disc: &RUNTIME_OPS[77],
    sum_new: &RUNTIME_OPS[78],
    sum_new_reuse: &RUNTIME_OPS[79],
    sum_payload: &RUNTIME_OPS[80],
    value_canonicalize: &RUNTIME_OPS[81],
    value_cmp: &RUNTIME_OPS[82],
    value_decode: &RUNTIME_OPS[83],
    value_encode: &RUNTIME_OPS[84],
    value_eq: &RUNTIME_OPS[85],
    value_eq_shaped: &RUNTIME_OPS[86],
    vec_concat: &RUNTIME_OPS[87],
    vec_drop: &RUNTIME_OPS[88],
    vec_empty: &RUNTIME_OPS[89],
    vec_get: &RUNTIME_OPS[90],
    vec_len: &RUNTIME_OPS[91],
    vec_of_arr: &RUNTIME_OPS[92],
    vec_push: &RUNTIME_OPS[93],
    vec_split: &RUNTIME_OPS[94],
    vec_update: &RUNTIME_OPS[95],
};
