...
pub const REQUIRED_RUNTIME_HASH: &str = match option_env!("CDZ_RUNTIME_HASH") {
    Some(h) => h,
    None => "05pyQ0IbjvRJg9eVcjS14wwX8PnqM9cVv2hOB3m1vHpFS",
};
...
pub const DEBUG_RUNTIME_HASH: &str = match option_env!("CDZ_DEBUG_RUNTIME_HASH") {
    Some(h) => h,
    None => "05YGzVLdcwKhxyw7uUIkxpLXYxQg8wOxNcccVh9uGG0tn",
};
...
pub const OPS: RuntimeOps = RuntimeOps {
    ...
    ast_print: &RUNTIME_OPS[5],
    bigint_add: &RUNTIME_OPS[6],
    bigint_cmp: &RUNTIME_OPS[7],
    bigint_div: &RUNTIME_OPS[8],
    bigint_mul: &RUNTIME_OPS[9],
    bigint_of_bytes: &RUNTIME_OPS[10],
    bigint_of_i64: &RUNTIME_OPS[11],
    bigint_rem: &RUNTIME_OPS[12],
    bigint_sub: &RUNTIME_OPS[13],
    bigint_to_i64_checked: &RUNTIME_OPS[14],
    box_bool: &RUNTIME_OPS[15],
    box_float: &RUNTIME_OPS[16],
    box_float32: &RUNTIME_OPS[17],
    box_int: &RUNTIME_OPS[18],
    bytes_alloc: &RUNTIME_OPS[19],
    bytes_compact: &RUNTIME_OPS[20],
    bytes_concat: &RUNTIME_OPS[21],
    bytes_get: &RUNTIME_OPS[22],
    bytes_len: &RUNTIME_OPS[23],
    bytes_set: &RUNTIME_OPS[24],
    bytes_slice: &RUNTIME_OPS[25],
    drop: &RUNTIME_OPS[26],
    dup: &RUNTIME_OPS[27],
    get_bool: &RUNTIME_OPS[28],
    get_float: &RUNTIME_OPS[29],
    get_float32: &RUNTIME_OPS[30],
    get_int: &RUNTIME_OPS[31],
    hash_blake3: &RUNTIME_OPS[32],
    live_objects: &RUNTIME_OPS[33],
    map_alloc: &RUNTIME_OPS[34],
    map_empty: &RUNTIME_OPS[35],
    map_insert: &RUNTIME_OPS[36],
    map_iter: &RUNTIME_OPS[37],
    map_iter_key: &RUNTIME_OPS[38],
    map_iter_next: &RUNTIME_OPS[39],
    map_iter_val: &RUNTIME_OPS[40],
    map_key: &RUNTIME_OPS[41],
    map_len: &RUNTIME_OPS[42],
    map_lookup: &RUNTIME_OPS[43],
    map_remove: &RUNTIME_OPS[44],
    map_set: &RUNTIME_OPS[45],
    map_size: &RUNTIME_OPS[46],
    map_to_list: &RUNTIME_OPS[47],
    map_val: &RUNTIME_OPS[48],
    rational_add: &RUNTIME_OPS[49],
    rational_cmp: &RUNTIME_OPS[50],
    rational_den: &RUNTIME_OPS[51],
    rational_div: &RUNTIME_OPS[52],
    rational_mul: &RUNTIME_OPS[53],
    rational_num: &RUNTIME_OPS[54],
    rational_of: &RUNTIME_OPS[55],
    rational_sub: &RUNTIME_OPS[56],
    reset: &RUNTIME_OPS[57],
    set_contains: &RUNTIME_OPS[58],
    set_difference: &RUNTIME_OPS[59],
    set_empty: &RUNTIME_OPS[60],
    set_insert: &RUNTIME_OPS[61],
    set_intersection: &RUNTIME_OPS[62],
    set_iter: &RUNTIME_OPS[63],
    set_iter_elem: &RUNTIME_OPS[64],
    set_iter_next: &RUNTIME_OPS[65],
    set_remove: &RUNTIME_OPS[66],
    set_size: &RUNTIME_OPS[67],
    set_to_list: &RUNTIME_OPS[68],
    set_union: &RUNTIME_OPS[69],
    str_from_bytes: &RUNTIME_OPS[70],
    str_get: &RUNTIME_OPS[71],
    str_new: &RUNTIME_OPS[72],
    str_nfc_normalize: &RUNTIME_OPS[73],
    sum_disc: &RUNTIME_OPS[74],
    sum_new: &RUNTIME_OPS[75],
    sum_new_reuse: &RUNTIME_OPS[76],
    sum_payload: &RUNTIME_OPS[77],
    value_canonicalize: &RUNTIME_OPS[78],
    value_cmp: &RUNTIME_OPS[79],
    value_decode: &RUNTIME_OPS[80],
    value_encode: &RUNTIME_OPS[81],
    value_eq: &RUNTIME_OPS[82],
    value_eq_shaped: &RUNTIME_OPS[83],
    vec_concat: &RUNTIME_OPS[84],
    vec_drop: &RUNTIME_OPS[85],
    vec_empty: &RUNTIME_OPS[86],
    vec_get: &RUNTIME_OPS[87],
    vec_len: &RUNTIME_OPS[88],
    vec_of_arr: &RUNTIME_OPS[89],
    vec_push: &RUNTIME_OPS[90],
    vec_split: &RUNTIME_OPS[91],
    vec_update: &RUNTIME_OPS[92],
};
