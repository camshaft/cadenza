{
  ...
  deliver = [
    { target = "reducer-state-delete-cdz", message = { contract = "cdz-platform.deliver", payload = b"DELETEME" } },
    { target = "reducer-state-delete-cdz", message = { contract = "cdz-platform.deliver", payload = b"DELETED" } }
  ],
