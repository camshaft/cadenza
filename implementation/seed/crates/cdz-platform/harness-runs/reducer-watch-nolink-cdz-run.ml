{
  ...
  blobs = [
    ...
    { name = "reducer-watch-nolink-check-cdz", program = "reducer-watch-nolink-check-cdz" }
  ],
  spawns = [
    { name = "watcher", blob = "reducer-watcher-cdz" },
    { name = "child", blob = "reducer-childexit-cdz", parent = "watcher" }
  ],
  deliver = [
    { target = "child", message = { contract = "cdz-platform.effect", payload = b"EXIT" } }
  ],
  checker = "reducer-watch-nolink-check-cdz"
}
