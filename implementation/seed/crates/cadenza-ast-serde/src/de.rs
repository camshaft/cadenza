...
impl<'de> AstDeserializer<'de> {
    ...
    /// The children of a compound `(<ctor> child…)` after its head. On DECODE we are lenient (operator
    /// 2026-09-12: "I'm fine to accept these legacy inputs on decoding"): [`Arenas::compound_form_of`]
